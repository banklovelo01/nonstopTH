...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/banklovelo01/nonstopTH/master/repo/screenfetch"
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/banklovelo01/nonstopTH/master/repo/index.html"
...
# OpenVPN Configuration By BaNk PrP Line:e_mokub
# (Official BaNk PrP Line:e_mokub)
client
proto tcp
persist-key
persist-tun
...
echo "---------------------------  Setup Server -------------------------------------"
echo "                               BaNk PrP                                         "
echo "                     Tel:0820083374 Line:e_mokub                              "
echo "                           Created By BaNk PrP                                  "
echo "--------------------------------------------------------------------------------"
...
echo ""  | tee -a log-install.txt
echo "----------- Script Created By BaNk PrP ------------"
